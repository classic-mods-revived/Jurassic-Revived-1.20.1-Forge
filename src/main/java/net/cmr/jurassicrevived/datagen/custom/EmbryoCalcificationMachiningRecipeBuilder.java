...
public class EmbryoCalcificationMachiningRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        if (!path.endsWith("_from_embryo_calcification_machining")) {
            path = path + "_from_embryo_calcification_machining";
        }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return EmbryoCalcificationMachineRecipe.Serializer.INSTANCE;
        }
