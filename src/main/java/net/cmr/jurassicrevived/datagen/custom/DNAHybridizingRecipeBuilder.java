...
public class DNAHybridizingRecipeBuilder implements RecipeBuilder {
    ...
    public DNAHybridizingRecipeBuilder addDNAWeight(Item item, int weight) {
    ...
    public DNAHybridizingRecipeBuilder addDNAWeight(ResourceLocation itemId, int weight) {
    ...
    public DNAHybridizingRecipeBuilder addAllItemsFromTagUniform(TagKey<Item> tag, int weight) {
    ...
    public static DNAHybridizingRecipeBuilder amberRandomDNAUniform(ItemLike ampoule,
                                                                    ItemLike amber,
                                                                    ItemLike resultPlaceholder,
                                                                    int uniformWeightPerDNA) {
        return new DNAHybridizingRecipeBuilder(ampoule, amber, resultPlaceholder, 1)
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return DNAHybridizerRecipe.Serializer.INSTANCE;
        }
