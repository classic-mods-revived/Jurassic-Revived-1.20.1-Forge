...
import net.cmr.jurassicrevived.entity.variant.IndominusRexVariant;
...
public class IndominusRexModel extends GeoModel<IndominusRexEntity> {
    ...
    private static final Map<IndominusRexVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(IndominusRexVariant.class), map -> {
                map.put(IndominusRexVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/indominus_rex.png"));
                map.put(IndominusRexVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/indominus_rex_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(IndominusRexEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/indominus_rex.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(IndominusRexEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(IndominusRexEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/indominus_rex.animation.json");
    }

    @Override
    public void setCustomAnimations(IndominusRexEntity entity, long id, AnimationState<IndominusRexEntity> state) {
        super.setCustomAnimations(entity, id, state);

        String[] tailBones = { "TailBASE", "Tail2", "Tail3", "Tail4", "Tail5", "Tail6", "Tail7", "Tail8" };
