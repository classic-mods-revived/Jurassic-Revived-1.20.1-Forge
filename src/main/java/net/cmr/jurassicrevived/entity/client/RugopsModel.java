...
public class RugopsModel extends GeoModel<RugopsEntity> {
    ...
    private static final Map<RugopsVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(RugopsVariant.class), map -> {
                map.put(RugopsVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/rugops.png"));
                map.put(RugopsVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/rugops_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(RugopsEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/rugops.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(RugopsEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(RugopsEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/rugops.animation.json");
    }

    @Override
    public void setCustomAnimations(RugopsEntity entity, long id, AnimationState<RugopsEntity> state) {
