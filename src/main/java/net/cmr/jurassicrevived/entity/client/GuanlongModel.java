...
public class GuanlongModel extends GeoModel<GuanlongEntity> {
    ...
    private static final Map<GuanlongVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(GuanlongVariant.class), map -> {
                map.put(GuanlongVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/guanlong.png"));
                map.put(GuanlongVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/guanlong_female.png"));
            });
    ...
    public ResourceLocation getModelResource(GuanlongEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/guanlong.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(GuanlongEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/guanlong.animation.json");
    }
