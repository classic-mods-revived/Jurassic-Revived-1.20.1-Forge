...
public class GiganotosaurusModel extends GeoModel<GiganotosaurusEntity> {
    ...
    private static final Map<GiganotosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(GiganotosaurusVariant.class), map -> {
                map.put(GiganotosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/giganotosaurus.png"));
                map.put(GiganotosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/giganotosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(GiganotosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/giganotosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(GiganotosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/giganotosaurus.animation.json");
    }
