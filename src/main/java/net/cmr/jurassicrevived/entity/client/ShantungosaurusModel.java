...
public class ShantungosaurusModel extends GeoModel<ShantungosaurusEntity> {

    private static final Map<ShantungosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ShantungosaurusVariant.class), map -> {
                map.put(ShantungosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/shantungosaurus.png"));
                map.put(ShantungosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/shantungosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(ShantungosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/shantungosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ShantungosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(ShantungosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/shantungosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(ShantungosaurusEntity entity, long id, AnimationState<ShantungosaurusEntity> state) {
