...
public class ProtoceratopsModel extends GeoModel<ProtoceratopsEntity> {

    private static final Map<ProtoceratopsVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ProtoceratopsVariant.class), map -> {
                map.put(ProtoceratopsVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/protoceratops.png"));
                map.put(ProtoceratopsVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/protoceratops_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(ProtoceratopsEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/protoceratops.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ProtoceratopsEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(ProtoceratopsEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/protoceratops.animation.json");
    }

    @Override
    public void setCustomAnimations(ProtoceratopsEntity entity, long id, AnimationState<ProtoceratopsEntity> state) {
