...
public class DistortusRexModel extends GeoModel<DistortusRexEntity> {
    ...
    private static final Map<DistortusRexVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(DistortusRexVariant.class), map -> {
                map.put(DistortusRexVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/distortus_rex.png"));
                map.put(DistortusRexVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/distortus_rex_female.png"));
            });
    ...
    public ResourceLocation getModelResource(DistortusRexEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/distortus_rex.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(DistortusRexEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/distortus_rex.animation.json");
    }
