...
public class EdmontosaurusModel extends GeoModel<EdmontosaurusEntity> {
    ...
    private static final Map<EdmontosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(EdmontosaurusVariant.class), map -> {
                map.put(EdmontosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/edmontosaurus.png"));
                map.put(EdmontosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/edmontosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(EdmontosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/edmontosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(EdmontosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/edmontosaurus.animation.json");
    }
