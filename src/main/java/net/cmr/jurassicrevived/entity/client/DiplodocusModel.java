...
public class DiplodocusModel extends GeoModel<DiplodocusEntity> {
    ...
    private static final Map<DiplodocusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(DiplodocusVariant.class), map -> {
                map.put(DiplodocusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/diplodocus.png"));
                map.put(DiplodocusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/diplodocus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(DiplodocusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/diplodocus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(DiplodocusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/diplodocus.animation.json");
    }
    ...
    public void setCustomAnimations(DiplodocusEntity entity, long id, AnimationState<DiplodocusEntity> state) {
        ...
        String[] tailBones = { "tailpart1", "tailpart2", "tailpart3", "tailpart4", "tailpart5", "tailpart6", "tailpart7", "tailpart8", "tailpart9", "tailpart10", "tailpart11", "tailpart12" };
        ...
        float[] weights = { 1.00f, 0.78f, 0.58f, 0.42f, 0.30f, 0.22f, 0.16f, 0.12f, 0.09f, 0.07f, 0.05f, 0.04f };
