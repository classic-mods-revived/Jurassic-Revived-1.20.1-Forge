...
public class ParasaurolophusModel extends GeoModel<ParasaurolophusEntity> {
    ...
    private static final Map<ParasaurolophusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ParasaurolophusVariant.class), map -> {
                map.put(ParasaurolophusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/parasaurolophus.png"));
                map.put(ParasaurolophusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/parasaurolophus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(ParasaurolophusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/parasaurolophus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ParasaurolophusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(ParasaurolophusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/parasaurolophus.animation.json");
    }

    @Override
    public void setCustomAnimations(ParasaurolophusEntity entity, long id, AnimationState<ParasaurolophusEntity> state) {
