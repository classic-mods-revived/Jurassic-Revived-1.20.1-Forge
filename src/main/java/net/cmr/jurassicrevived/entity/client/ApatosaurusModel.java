...
import net.cmr.jurassicrevived.entity.variant.ApatosaurusVariant;
...
public class ApatosaurusModel extends GeoModel<ApatosaurusEntity> {
    ...
    private static final Map<ApatosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ApatosaurusVariant.class), map -> {
                map.put(ApatosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/apatosaurus.png"));
                map.put(ApatosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/apatosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(ApatosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/apatosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(ApatosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/apatosaurus.animation.json");
    }
