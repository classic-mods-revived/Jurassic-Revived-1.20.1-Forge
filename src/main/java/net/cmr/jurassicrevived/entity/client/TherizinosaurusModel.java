...
public class TherizinosaurusModel extends GeoModel<TherizinosaurusEntity> {
    ...
    private static final Map<TherizinosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TherizinosaurusVariant.class), map -> {
                map.put(TherizinosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/therizinosaurus.png"));
                map.put(TherizinosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/therizinosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(TherizinosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/therizinosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TherizinosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(TherizinosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/therizinosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(TherizinosaurusEntity entity, long id, AnimationState<TherizinosaurusEntity> state) {
