...
public class MajungasaurusModel extends GeoModel<MajungasaurusEntity> {
    ...
    private static final Map<MajungasaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MajungasaurusVariant.class), map -> {
                map.put(MajungasaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/majungasaurus.png"));
                map.put(MajungasaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/majungasaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(MajungasaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/majungasaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MajungasaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(MajungasaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/majungasaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(MajungasaurusEntity entity, long id, AnimationState<MajungasaurusEntity> state) {
