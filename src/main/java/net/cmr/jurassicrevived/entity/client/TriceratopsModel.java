...
public class TriceratopsModel extends GeoModel<TriceratopsEntity> {
    ...
    private static final Map<TriceratopsVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TriceratopsVariant.class), map -> {
                map.put(TriceratopsVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/triceratops.png"));
                map.put(TriceratopsVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/triceratops_female.png"));
            });
    ...
    public ResourceLocation getModelResource(TriceratopsEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/triceratops.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(TriceratopsEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/triceratops.animation.json");
    }

    @Override
    public void setCustomAnimations(TriceratopsEntity entity, long id, AnimationState<TriceratopsEntity> state) {
