...
import net.cmr.jurassicrevived.entity.variant.ChickenosaurusVariant;
...
public class ChickenosaurusModel extends GeoModel<ChickenosaurusEntity> {
    ...
    private static final Map<ChickenosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ChickenosaurusVariant.class), map -> {
                map.put(ChickenosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/chickenosaurus.png"));
                map.put(ChickenosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/chickenosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(ChickenosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/chickenosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(ChickenosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/chickenosaurus.animation.json");
    }
