...
import net.cmr.jurassicrevived.entity.variant.AlbertosaurusVariant;
...
public class AlbertosaurusModel extends GeoModel<AlbertosaurusEntity> {
    ...
    private static final Map<AlbertosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(AlbertosaurusVariant.class), map -> {
                map.put(AlbertosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/albertosaurus.png"));
                map.put(AlbertosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/albertosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(AlbertosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/albertosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(AlbertosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/albertosaurus.animation.json");
    }
