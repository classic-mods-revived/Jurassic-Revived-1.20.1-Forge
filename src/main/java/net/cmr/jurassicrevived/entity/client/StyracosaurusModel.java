...
import net.cmr.jurassicrevived.entity.custom.StyracosaurusEntity;
...
public class StyracosaurusModel extends GeoModel<StyracosaurusEntity> {
    ...
    private static final Map<StyracosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(StyracosaurusVariant.class), map -> {
                map.put(StyracosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/styracosaurus.png"));
                map.put(StyracosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/styracosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(StyracosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/styracosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(StyracosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/styracosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(StyracosaurusEntity entity, long id, AnimationState<StyracosaurusEntity> state) {
