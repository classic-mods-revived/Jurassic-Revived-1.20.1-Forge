...
public class SpinosaurusModel extends GeoModel<SpinosaurusEntity> {
    ...
    private static final Map<SpinosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(SpinosaurusVariant.class), map -> {
                map.put(SpinosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/spinosaurus.png"));
                map.put(SpinosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/spinosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(SpinosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/spinosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(SpinosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/spinosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(SpinosaurusEntity entity, long id, AnimationState<SpinosaurusEntity> state) {
