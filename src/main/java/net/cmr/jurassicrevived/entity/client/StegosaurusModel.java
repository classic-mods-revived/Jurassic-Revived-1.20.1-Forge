...
public class StegosaurusModel extends GeoModel<StegosaurusEntity> {
    ...
    private static final Map<StegosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(StegosaurusVariant.class), map -> {
                map.put(StegosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/stegosaurus.png"));
                map.put(StegosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/stegosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(StegosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/stegosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(StegosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/stegosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(StegosaurusEntity entity, long id, AnimationState<StegosaurusEntity> state) {
        ...
        GeoBone head = (GeoBone) getAnimationProcessor().getBone("Neck3");
