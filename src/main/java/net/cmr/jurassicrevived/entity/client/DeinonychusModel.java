...
public class DeinonychusModel extends GeoModel<DeinonychusEntity> {
    ...
    private static final Map<DeinonychusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(DeinonychusVariant.class), map -> {
                map.put(DeinonychusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/deinonychus.png"));
                map.put(DeinonychusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/deinonychus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(DeinonychusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/deinonychus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(DeinonychusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/deinonychus.animation.json");
    }
