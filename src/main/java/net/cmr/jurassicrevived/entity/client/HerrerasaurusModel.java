...
public class HerrerasaurusModel extends GeoModel<HerrerasaurusEntity> {
    ...
    private static final Map<HerrerasaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(HerrerasaurusVariant.class), map -> {
                map.put(HerrerasaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/herrerasaurus.png"));
                map.put(HerrerasaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/herrerasaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(HerrerasaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/herrerasaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HerrerasaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(HerrerasaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/herrerasaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(HerrerasaurusEntity entity, long id, AnimationState<HerrerasaurusEntity> state) {
        ...
        GeoBone head = (GeoBone) getAnimationProcessor().getBone("Neckunder1");
