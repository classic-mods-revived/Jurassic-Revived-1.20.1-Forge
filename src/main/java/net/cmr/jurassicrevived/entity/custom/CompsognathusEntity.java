...
import net.cmr.jurassicrevived.entity.variant.CompsognathusVariant;
...
public class CompsognathusEntity extends Animal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        AgeableMob child = ModEntities.COMPSOGNATHUS.get().create(pLevel);
        if (child instanceof CompsognathusEntity baby) {
            CompsognathusVariant randomVariant = Util.getRandom(CompsognathusVariant.values(), this.random);
    ...
    public boolean canMate(Animal other) {
        ...
        if (!(other instanceof CompsognathusEntity that)) return false;
