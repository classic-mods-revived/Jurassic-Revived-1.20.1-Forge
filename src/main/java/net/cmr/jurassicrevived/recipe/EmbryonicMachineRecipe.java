...
public class EmbryonicMachineRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<EmbryonicMachineRecipe> {
        private Type() { }
    ...
    public static class Serializer implements RecipeSerializer<EmbryonicMachineRecipe> {
        ...
        public EmbryonicMachineRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new EmbryonicMachineRecipe(id, output, inputs);
        }
