...
public class DNAAnalyzerScreen extends AbstractContainerScreen<DNAAnalyzerMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/gui/dna_analyzer/dna_analyzer_gui.png");
    private static final ResourceLocation DNA_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/gui/generic/syringe_dna.png");
