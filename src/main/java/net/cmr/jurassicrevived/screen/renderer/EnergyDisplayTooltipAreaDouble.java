 ...
 */
public class EnergyDisplayTooltipAreaDouble {
    ...
    public EnergyDisplayTooltipAreaDouble(int xMin, int yMin, IEnergyStorage energy)  {
        this(xMin, yMin, energy,16,64);
    }

    public EnergyDisplayTooltipAreaDouble(int xMin, int yMin, IEnergyStorage energy, int width, int height)  {
        xPos = xMin;
        yPos = yMin;
        this.width = width;
        this.height = height;
