...
public class DNAExtractorRecipe implements Recipe<SimpleContainer> {
    ...
    public DNAExtractorRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputItems) {
    ...
    public static class Serializer implements RecipeSerializer<DNAExtractorRecipe> {
        ...
        public static final ResourceLocation ID =
                ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID,"dna_extracting");

        @Override
        public DNAExtractorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new DNAExtractorRecipe(id, output, inputs, weights);
        }

        @Override
        public DNAExtractorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, DNAExtractorRecipe recipe) {
